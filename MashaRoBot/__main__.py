...
꧁*CHECK ALL BUTTON BELOW TO EXPLORE EVERY COMMANDS OF 𝕌𝕟𝕚𝕂*꧂

𖣘 *All commands can either be used with* `/` *or* `!`.

𖣘 *If you facing any issue or find any bugs in any command then you can report it in @little_tekk*
"""
